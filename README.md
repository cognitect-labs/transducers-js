...
* Latest release: 0.4.166

### JavaScript

You can include either the [release](http://cdn.cognitect.com/transducers/transducers-0.4.166-min.js) (2K gzipped) or [development](http://cdn.cognitect.com/transducers/transducers-0.4.166.js) build of transducers-js on your webpage. We also provide [Require.js](http://requirejs.org) compatible [release](http://cdn.cognitect.com/transducers/transducers-0.4.166-amd-min.js) and [dev](http://cdn.cognitect.com/transducers/transducers-0.4.166-amd.js) builds.
