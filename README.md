...
* Latest release: 0.4.80

### JavaScript

You can include either the [release](http://cdn.cognitect.com/transducers/transducers-0.4.80-min.js)(8.9K gzipped) or [development](http://cdn.cognitect.com/transducers/transducers-0.4.80.js) build of transducers-js on your webpage. We also provide [Require.js](http://requirejs.org) compatible [release](http://cdn.cognitect.com/transducers/transducers-0.4.80-amd-min.js) and [dev](http://cdn.cognitect.com/transducers/transducers-0.4.80-amd.js) builds.
