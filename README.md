...
* Latest release: 0.4.89

### JavaScript

You can include either the [release](http://cdn.cognitect.com/transducers/transducers-0.4.89-min.js)(2K gzipped) or [development](http://cdn.cognitect.com/transducers/transducers-0.4.89.js) build of transducers-js on your webpage. We also provide [Require.js](http://requirejs.org) compatible [release](http://cdn.cognitect.com/transducers/transducers-0.4.89-amd-min.js) and [dev](http://cdn.cognitect.com/transducers/transducers-0.4.89-amd.js) builds.
